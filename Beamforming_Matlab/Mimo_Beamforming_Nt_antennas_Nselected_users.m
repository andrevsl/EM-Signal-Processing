...
tempH=[ones(Nuselec,1),exp(1j*pi*sin(phiu(ph))).',exp(1j*pi*2*sin(phiu(ph))).',exp(1j*pi*3*sin(phiu(ph))).',...
   exp(1j*pi*4*sin(phiu(ph))).',exp(1j*pi*5*sin(phiu(ph))).',exp(1j*pi*6*sin(phiu(ph))).',exp(1j*pi*7*sin(phiu(ph))).',...
    exp(1j*pi*8*sin(phiu(ph))).',exp(1j*pi*9*sin(phiu(ph))).',exp(1j*pi*10*sin(phiu(ph))).'];
